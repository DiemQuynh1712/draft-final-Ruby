...
class RoomtypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create roomtype" do
    assert_difference("Roomtype.count") do
      post roomtypes_url, params: { roomtype: { description: @roomtype.description, name: @roomtype.name, price_per_night: @roomtype.price_per_night, roomsize_m2: @roomtype.roomsize_m2 } }
    end
  ...
  test "should update roomtype" do
    patch roomtype_url(@roomtype), params: { roomtype: { description: @roomtype.description, name: @roomtype.name, price_per_night: @roomtype.price_per_night, roomsize_m2: @roomtype.roomsize_m2 } }
